...
data_analyst_agent = Agent(
    role = 'Data Analyst',
    goal = "Analyze gathered information to rextract key findings, insights, patterns and conclusions",
    backstory = (
        ...
        "and key findings from research data with high relevance to the topic provided."
    ),
    llm = llm,
    tools = [FileReadTool()],
    verbose = True,
